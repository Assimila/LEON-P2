...
Predict_BII <- function(UML_data, 
  ...
  for (i in 1:nrow(UML_data)){
    ...
    Extent_inter <- relate(WC_layer, coordinates_mills_buffer, "intersects")
    if(Extent_inter){
    ...
    writeRaster(
      Raster_outout,
      paste0(
        '../../results/2_biodiversity_metrics_site_level/BII_rasters_UML/13_02_2026/', Year, '/',
        UML_data$UML.ID[i],
        '.tif'
      ),
...
#| output: false 
#| echo: true 
Set1 <- read.csv('../../results/2_biodiversity_metrics_site_level/BII_mills_tables/UML_197mills_2020.csv') %>% 
  mutate(Year=2020)
Set2 <-  read.csv('../../results/2_biodiversity_metrics_site_level/BII_mills_tables/UML_197mills_2021.csv') %>% 
  mutate(Year=2021)
...
ggtitle('Distribution of median BBI across mills') +
  facet_wrap(~Year) + xlab('Median BII'),
...
Example2020 <- rast("../../results/2_biodiversity_metrics_site_level/BII_rasters_UML/13_02_2026/2020/PO1000000052.tif")
